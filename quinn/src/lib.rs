...
impl<'a> EndpointBuilder<'a> {
    ...
    /// Build an endpoint bound to an unspecified free port.
    ///
    /// A good default behavior for clients.
    pub fn build(self) -> Result<(Endpoint, Driver, Incoming), Error> {
        self.bind(SocketAddrV6::new(Ipv6Addr::UNSPECIFIED, 0, 0, 0))
    }
